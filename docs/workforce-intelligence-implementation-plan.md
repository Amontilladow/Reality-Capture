...
| Attendance / clock-in-clock-out | Out of scope — this is a time-and-attendance HR function with its own compliance surface (breaks, overtime law); not this product's job, and not requested by the brief's core loop. |
