...
export class StorageService {
  ...
  generateKey(companyId: string, projectId: string, type: 'captures' | 'drawings' | 'documents' | 'avatars' | 'issues' | 'rfi-attachments' | 'branding' | 'snag-items', filename: string): string {
